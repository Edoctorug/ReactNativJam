"""
Django settings for edoctorugAPI project.
...
SECRET_KEY = 'django-insecure-3ysd^(9d=c3ehzf-$p4$igux9h-!jiqyx(@m@r6sdz#5=2%k)h'
...
#         'rest_framework_jwt.authentication.JSONWebToken'
#     )

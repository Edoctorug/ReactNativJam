      ...
      <ScrollView>
        ...
        >
          <View style={styles.container}>
            ...
            {(value === "clinic" || value === "pharmacy" || value === "hospital" || value === "hospital") && (
              <>
                <TouchableOpacity
                 
                  onPress={_pickPhamaLiecence}
                >
                  <Text style={[styles.attachment]}>Pharmaceautical licence...</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  
                  onPress={_pickOperationLiecence}
                >
